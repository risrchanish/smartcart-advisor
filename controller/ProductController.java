...
@RestController
@RequestMapping("/product/api")   // Base Url: http://localhost:8081/product/api
public class ProductController {
	...
	@GetMapping("/{productId}")    // http://localhost:8081/product/api/{value}
	...
	@GetMapping("/all")  // http://localhost:8081/product/api/all
	...
	@GetMapping("/category")      // http://localhost:8081/product/api/category?category={value}
	...
	@GetMapping("/name")  // http://localhost:8081/product/api/name?name={value}
	...
	@GetMapping("/search")     // http://localhost:8081/product/api/search?name={value}&name2={value}
	...
	@GetMapping("/sort/name")      // http://localhost:8081/product/api/sort/name
	...
	@GetMapping("/pricerange")				//  http://localhost:8081/product/api/pricerange
	...
	@PutMapping("/update/{productId}")      // http://localhost:8081/product/api/update/{value}
